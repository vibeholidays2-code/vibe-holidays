...
async function updateBali25000NewFormat() {
  try {
...
🛏️ Deluxe Room – 2 Nights – Bed & Breakfast
...
Always available on call/WhatsApp during the trip`;
    ...
    const result = await packagesCollection.updateOne(
      { name: "Bali Budget Package", price: 25000 },
      {
        $set: {
    ...
    if (result.modifiedCount > 0) {
      console.log('\n✅ Bali ₹25,000 package updated successfully with new format!');
      console.log('Modified count:', result.modifiedCount);
      console.log('\nPackage Details:');
      console.log('- Price: ₹25,000');
