...
async function verifyPackage() {
  ...
  try {
    ...
    const singaporePackages = await packages.find({ destination: 'Singapore' }).toArray();
    
    console.log(`Found ${singaporePackages.length} Singapore package(s):\n`);
    
    singaporePackages.forEach((pkg, index) => {
