...
async function addNewBaliLuxuryPackage() {
  try {
    ...
    // Step 1: Delete all old Bali packages
    ...
    // Step 2: Add new Bali Luxury Package
    console.log('📝 Adding new Bali 4★ Luxury Package...');
    
    const newBaliPackage = {
      ...
      images: [
        "https://res.cloudinary.com/dpsytvwmh/image/upload/v1234567890/bali/bali-luxury-1.jpg",
        "https://res.cloudinary.com/dpsytvwmh/image/upload/v1234567890/bali/bali-luxury-2.jpg",
        "https://res.cloudinary.com/dpsytvwmh/image/upload/v1234567890/bali/bali-luxury-3.jpg"
      ],
      coverImage: "https://res.cloudinary.com/dpsytvwmh/image/upload/v1234567890/bali/bali-luxury-cover.jpg",
      gallery: [],
      ...
      minAge: 5,
      cancellationPolicy: {
        moreThan4Weeks: "Booking Amount + ₹2,500 per person",
        fourWeeks: "25% of total package cost",
        threeWeeks: "50% of total package cost",
        twoWeeks: "75% of total package cost",
        lessThan2Weeks: "100% Non-Refundable"
      },
      importantNotes: [
        "Rates are date-wise different – confirm before booking",
        "All tours are private with dedicated vehicle and driver",
        "Package cost is per person on twin sharing basis",
        "GST and TCS applicable as per government norms",
        "Visa assistance available on request"
      ],
      whatsIncludedIcons: {
        accommodation: true,
        meals: true,
    ...
    const savedPackage = await Package.create(newBaliPackage);
    console.log(`✅ Successfully added: ${savedPackage.name}`);
    console.log(`   Package ID: ${savedPackage._id}`);
    console.log(`   Price: ₹${savedPackage.price} per person`);
    console.log(`   Duration: ${savedPackage.duration}\n`);
