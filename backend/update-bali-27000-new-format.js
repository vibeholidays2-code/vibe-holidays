...
async function updateBali27000NewFormat() {
  try {
...
• Less than 2 weeks / No Show: 100% Non-Refundable`;
    ...
    const result = await packagesCollection.updateOne(
      { name: "Bali Standard Package", price: 27000 },
      {
        $set: {
    ...
    if (result.modifiedCount > 0) {
      console.log('\n✅ Bali ₹27,000 package updated successfully with new format!');
      ...
      console.log('- Special Feature: Private Pool Villa in Ubud');
    } else {
