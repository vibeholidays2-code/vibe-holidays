          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="mt-4 text-center">
                <p className="text-gray-600 text-sm mb-3">Or chat with us directly</p>
                <a
                  href="https://wa.me/917048505128?text=Hi%2C%20I%20would%20like%20to%20inquire%20about%20your%20travel%20packages"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-lg transition-colors shadow-md hover:shadow-lg"
                >
                  <svg
