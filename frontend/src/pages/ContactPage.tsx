...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO
        title="Contact Us"
        description="Get in touch with Vibe Holidays. Contact us for inquiries, custom packages, or any questions about your travel plans. We're here to help!"
        keywords="contact travel agency, travel inquiries, holiday booking contact, travel support, customer service"
        url="/contact"
      />
      {/* Header Section */}
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">+91 7048505128</p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">vibesholidays.9@gmail.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="https://twitter.com/vibeholidays"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://linkedin.com/company/vibeholidays"
                  target="_blank"
                  rel="noopener noreferrer"
